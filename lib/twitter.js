...
function TwitterKeys(consumerKey, consumerSecret, token, tokenSecret) {
...
var TwitterURLBase = Object.freeze({
...
function rest(keys, method, apiName, params) {
    ...
    var options = {
        ...
        "method": method,
        "url"   : TwitterURLBase.rest + apiName + ".json"
    };
    switch (method) {
        case "GET":
            options["qs"] = params;
